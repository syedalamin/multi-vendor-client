...
//     window.addEventListener("scroll", handleScroll);
//     return () => window.removeEventListener("scroll", handleScroll);
//   }, [currentPage, mergedData, isFetching, productData]);
...
//     content = <Typography py={4}>No Data Found</Typography>;
//   } else {
//     content = (
//       <Stack py={4}>
//         <Grid container spacing={2} alignItems={"center"}>
...
//     product = <Loading />;
//   } else if (!productData?.success || productData.data.length === 0) {
//     product = <Typography py={4}>No Data Found</Typography>;
//   } else {
//     product = (
//       <Stack py={4}>
//         <Grid container spacing={2} alignItems={"center"}>
