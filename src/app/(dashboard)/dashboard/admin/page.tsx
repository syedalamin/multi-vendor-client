...
import { useGetAllAdminMetaDataQuery } from "@/redux/api/metaDataApi";

const AdminPage = () => {
  const { data } = useGetAllAdminMetaDataQuery({});
  ...
  const cards = [
    ...
    {
      title: "Total Users",
      count: meta?.allUser?._count?.id ?? 0,
      icon: <PeopleIcon fontSize="large" />,
      color: "#3949ab",
    },
    {
      title: "Admins",
      count: meta?.allAdmin?._count?.id ?? 0,
      icon: <AdminPanelSettingsIcon fontSize="large" />,
      color: "#6a1b9a",
    },
    {
      title: "Vendors",
      count: meta?.allVendor?._count?.id ?? 0,
      icon: <StorefrontIcon fontSize="large" />,
      color: "#00897b",
    },
    {
      title: "Customers",
      count: meta?.allCustomer?._count?.id ?? 0,
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          ...
          >
            ...
            <PieChart
              ...
              sx={{
                "& path": { transition: "all 0.3s ease-in-out" },
                width: "100%",
              }}
            />
          </Card>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          ...
          >
            ...
            <BarChart
              ...
              height={250}
              sx={{
                "& rect": { transition: "all 0.3s ease-in-out" },
                width: "100%",
              }}
            />
          </Card>
